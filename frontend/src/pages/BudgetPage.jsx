        ...
        >
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                className="w-full rounded-2xl border border-slate-700 bg-slate-900/60 px-4 py-3 text-white outline-none transition focus:border-cyan-500"
          ...
          {income?.length ? (
            ...
            <div className="flex flex-col items-center justify-center rounded-3xl border border-dashed border-slate-700 py-20 text-center">
              ...
              <p className="mt-3 max-w-md text-slate-400">
                ...
                Add your salary or other income sources to
                monitor your financial growth and savings.
